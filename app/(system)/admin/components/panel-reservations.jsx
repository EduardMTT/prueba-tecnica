...
export default function PanelReservations() {
  ...
  const handleUpdate = async (reservation, newStatus) => {
    await updateReservationMutation.mutateAsync({
      id: reservation.id,
      formData: { ...reservation, Status: newStatus },
    });
  };
  if (isPending) {
    return (
            ...
            >
              ...
              <CardFooter className="flex justify-end gap-2 pt-2">
                <Button
                  ...
                  size="sm"
                  onClick={() => {
                    handleUpdate(reservation, 'accepted');
                  }}
                  className="bg-gradient-to-tl from-blue-800 to-cyan-400"
                >
                  Confirmar
                </Button>
                <Button
